...
(() => {
    ...
    const basicCommandDefinition = {
        ...
        description: "Launches the Oopis Basic Integrated Development Environment, a complete environment for line-numbered programming with advanced functions.",
...
SYSTEM BRIDGE
    ...
    CommandRegistry.register(basicCommandDefinition);
})();